		...
		<div class="row justify-content-center">
			<div class="col-xl-7 ftco-animate">
				<!-- <form action="#" class="billing-form"> -->
					...
					{!!Form::open(['action' => 'MpesaController@stkPush','method' => 'POST', 'class'=>'billing-form'])!!}
					{{csrf_field()}}
		      ...
		      <div class="col-md-6">
		      	<div class="form-group">
		      		...
		      		<input type="text" class="form-control" name="location" placeholder="Appartment, suite, unit etc: (optional)">
		      	</div>
		      </div>
		      <div class="w-100"></div>
		      <div class="col-md-6">
		      ...
		      {{--{{Form::submit('Buy Now', ['class'=>'btn-sm btn btn-success'])}}
		      {!!Form::close()!!}--}}
