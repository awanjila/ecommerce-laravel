	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="price">Ksh{{$product['product_price']}}</td>
						       {!!Form::open(['action' => 'ClientController@updateqty','method' => 'POST'])!!}
						        ...
						        {{Form::submit('Update', ['class'=>'btn-sm btn btn-success'])}}
                   				{!!Form::close()!!}
					          </td>
						        
						        <td class="total">Ksh{{$product['product_price']*$product['qty']}}</td>
						      </tr>
						      @endforeach
						    	@else
						    	@endif
    		...
    		<div class="row justify-content-end">
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
	              ...
	              <div class="form-group">
    				...
    				<p><a href="{{URL::to('/checkout')}}" class="btn btn-primary py-3 px-4">Apply Coupon</a></p>
    			</div>
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
	              ...
	              <div class="form-group">
    				...
    				<p><a href="{{URL::to('/')}}" class="btn btn-primary py-3 px-4">Estimate</a></p>
    			</div>
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					<h3>Cart Totals</h3>
